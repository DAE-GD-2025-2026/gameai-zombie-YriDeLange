...
#include "BTTask_UseItemDeLangeYri.h"
#include "AIController.h"
#include "Survivor/SurvivorPawn.h"
#include "Common/InventoryComponent.h"
#include "Items/BaseItem.h"

UBTTask_UseItemDeLangeYri::UBTTask_UseItemDeLangeYri()
{
	NodeName = "Use Item";
}

EBTNodeResult::Type UBTTask_UseItemDeLangeYri::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
