...
#include "BTTask_ExploreDeLangeYri.h"
...
UBTTask_ExploreDeLangeYri::UBTTask_ExploreDeLangeYri()
{
	NodeName = "Explore";
	bNotifyTick = true;
...
EBTNodeResult::Type UBTTask_ExploreDeLangeYri::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
EBTNodeResult::Type UBTTask_ExploreDeLangeYri::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
bool UBTTask_ExploreDeLangeYri::BeginMoveToDestination(AAIController* AI, ASurvivorPawn* Survivor)
{
	TargetHouse = nullptr;
	...
	if (UStudentPerceptorDeLangeYri* Perceptor = Survivor->GetComponentByClass<UStudentPerceptorDeLangeYri>())
	{
...
void UBTTask_ExploreDeLangeYri::FaceVelocity(ASurvivorPawn* Survivor, float DeltaSeconds) const
{
...
void UBTTask_ExploreDeLangeYri::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
