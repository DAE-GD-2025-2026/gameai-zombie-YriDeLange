...
#include "StudentPerceptorDeLangeYri.generated.h"
...
class DELANGEYRIZOMBIERUNTIME_API UStudentPerceptorDeLangeYri : public UActorComponent
{
	GENERATED_BODY()

public:
	UStudentPerceptorDeLangeYri();
