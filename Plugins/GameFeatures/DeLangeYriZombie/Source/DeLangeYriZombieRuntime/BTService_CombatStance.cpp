...
#include "BTService_CombatStance.h"
...
UBTService_CombatStance::UBTService_CombatStance()
{
	NodeName = "Combat Stance";
	Interval = 0.2f;
	RandomDeviation = 0.05f;
	StanceKey.AddIntFilter(this, GET_MEMBER_NAME_CHECKED(UBTService_CombatStance, StanceKey));
}

bool UBTService_CombatStance::HasUsableWeapon(const UInventoryComponent* Inv)
{
...
void UBTService_CombatStance::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
