...
#include "BTService_SelectLootDeLangeYri.h"
...
UBTService_SelectLootDeLangeYri::UBTService_SelectLootDeLangeYri()
{
	NodeName = "Select Loot";
	Interval = 0.2f;
	RandomDeviation = 0.05f;

	LootTargetKey.AddObjectFilter(this, GET_MEMBER_NAME_CHECKED(UBTService_SelectLootDeLangeYri, LootTargetKey), ABaseItem::StaticClass());
	HealthFractionKey.AddFloatFilter(this, GET_MEMBER_NAME_CHECKED(UBTService_SelectLootDeLangeYri, HealthFractionKey));
}

int32 UBTService_SelectLootDeLangeYri::FindFreeSlot(const UInventoryComponent* Inv)
{
...
bool UBTService_SelectLootDeLangeYri::HasUsableWeapon(const UInventoryComponent* Inv)
{
...
ABaseItem* UBTService_SelectLootDeLangeYri::PickBestItem(ASurvivorPawn* Survivor, float HealthFraction) const
{
...
void UBTService_SelectLootDeLangeYri::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
