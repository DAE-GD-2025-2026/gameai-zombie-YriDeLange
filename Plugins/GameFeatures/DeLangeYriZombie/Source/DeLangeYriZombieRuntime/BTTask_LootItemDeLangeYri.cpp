...
#include "BTTask_LootItemDeLangeYri.h"
...
UBTTask_LootItemDeLangeYri::UBTTask_LootItemDeLangeYri()
{
	NodeName = "Loot Item";
	bNotifyTick = true;
	bCreateNodeInstance = true;
	LootTargetKey.AddObjectFilter(this, GET_MEMBER_NAME_CHECKED(UBTTask_LootItemDeLangeYri, LootTargetKey), ABaseItem::StaticClass());
}
...
EBTNodeResult::Type UBTTask_LootItemDeLangeYri::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_LootItemDeLangeYri::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	AAIController* AI = OwnerComp.GetAIOwner();
...
EBTNodeResult::Type UBTTask_LootItemDeLangeYri::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
